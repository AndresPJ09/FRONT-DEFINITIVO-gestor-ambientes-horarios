    ...
    const handleSubmit = async (formData) => {
      try {
        ...
        if (selectedRow) {
          ...
          Swal.fire("Competencia actualizada", "", "success");
        } else {
          await Service.post("/competencia/", { ...formData, estado: true });
          Swal.fire("Competencia creada", "", "success");
        }
        await fetchData();
        handleCloseModal();
      } catch (error) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          try {
            ...
            Swal.fire({
              title: "Error",
              text: "No se pudo eliminar el competencia. Por favor, inténtalo de nuevo más tarde.",
              icon: "error",
