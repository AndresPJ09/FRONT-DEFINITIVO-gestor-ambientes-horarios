...
export function TablePrograma() {
  ...
  const handleSubmit = async (formData) => {
    try {
      ...
      if (selectedRow) {
        ...
        await Service.post("/programa/", formData)
      }
      fetchData()
      setIsModalOpen(false)
      setSelectedRow(null)
      showSwal("success", "Programa guardado exitosamente")
    } catch (error) {
      ...
      showSwal("error", "Error al guardar el programa", errorMessage)
    }
  }
  ...
  const modalFields = [
    ...
    },
    {
      ...
      type: "select",
      required: true,
      value: selectedRow?.nivel_formacion_id || "",
      options: dataNivelFormacion
    },
    selectedRow
      ? {
        label: "Estado",
