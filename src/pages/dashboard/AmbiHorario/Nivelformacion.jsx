    ...
    const handleSubmit = async (formData) => {
        try {
            ...
            if (selectedRow) {
                ...
                Swal.fire("Nivel actualizado", "", "success");
            } else {
                await Service.post("/nivelformacion/", { ...formData, estado: true });
                Swal.fire("Nivel creado", "", "success");
            }
            await fetchData();
            handleCloseModal();
        } catch (error) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            try {
              ...
              Swal.fire({
                title: "Nivel de formación eliminado",
                icon: "success",
              ...
              Swal.fire({
                title: "Error",
                text: "No se pudo eliminar el nivel. Por favor, inténtalo de nuevo.",
                icon: "error",
