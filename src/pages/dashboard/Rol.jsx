...
export function TableRol() {
  ...
  const handleSubmit = async (formData) => {
    try {
      ...
      setSelectedRow(null)
      showSwal("success", "Rol guardado exitosamente")
    } catch (error) {
      ...
      showSwal("error", "Error al guardar el rol", errorMessage)
    }
  }
    ...
    Swal2.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          showSwal("success", "Rol eliminado correctamente")
          fetchData()
        } catch (error) {
          console.error("Error al eliminar el rol:", error)
          showSwal("error", "Error al eliminar el rol", "Inténtalo de nuevo más tarde.")
        }
      }
    })
  }
